...
var _user$project$Customers$update = F2(
	function (msg, model) {
		return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
	});
var _user$project$Customers$margin1 = A2(_debois$elm_mdl$Material_Options$css, 'margin', '0');
var _user$project$Customers$white = _debois$elm_mdl$Material_Color$text(_debois$elm_mdl$Material_Color$white);
var _user$project$Customers$anMdlCard = A2(
	_debois$elm_mdl$Material_Card$view,
	{
		...
		_1: {
			...
			_1: {
				ctor: '::',
				_0: A2(_debois$elm_mdl$Material_Options$css, 'background', 'url(\'https://2.bp.blogspot.com/-CAtiru0_Wgk/V7PgKQQ3e1I/AAAAAAAF85Y/KI-9G5903Gg7y_Wog47Ogib3f-Gc22kWwCLcB/s1600/cupcake-778704_960_720.png\') center / cover'),
				_1: {
					ctor: '::',
					_0: _user$project$Customers$margin1,
					_1: {ctor: '[]'}
				}
			}
		}
	},
	{
		...
		_1: {
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: A2(_debois$elm_mdl$Material_Options$css, 'background', 'rgba(0, 0, 0, 0.5)'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _user$project$Customers$white,
							_1: {
								ctor: '::',
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Mary Moo'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}),
...
var _user$project$Customers$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _user$project$Customers$anMdlCard,
			_1: {
				ctor: '::',
				_0: _user$project$Customers$anMdlCard,
				_1: {
...
var _user$project$Customers$Mdl = function (a) {
	return {ctor: 'Mdl', _0: a};
};

var _user$project$Empty$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text('Empty Page'),
			_1: {ctor: '[]'}
		});
};
var _user$project$Empty$update = F2(
	function (msg, model) {
		return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
	});
var _user$project$Empty$Mdl = function (a) {
	return {ctor: 'Mdl', _0: a};
};

var _user$project$Reactor$e404 = function (_p0) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
...
var _user$project$Reactor$Model = F5(
	function (a, b, c, d, e) {
		return {mdl: a, customersModel: b, ordersModel: c, inventoryModel: d, selectedTab: e};
	});
var _user$project$Reactor$CustomerModel = function (a) {
	return {list: a};
};
var _user$project$Reactor$EmptyModel = {};
var _user$project$Reactor$model = {
	mdl: _debois$elm_mdl$Material$model,
	customersModel: _user$project$Reactor$CustomerModel(
		{
			ctor: '::',
			_0: 'joe',
			_1: {
	...
	ordersModel: _user$project$Reactor$EmptyModel,
	inventoryModel: _user$project$Reactor$EmptyModel,
	selectedTab: 0
};
var _user$project$Reactor$Mdl = function (a) {
	return {ctor: 'Mdl', _0: a};
};
var _user$project$Reactor$init = function () {
	var c = A2(_elm_lang$core$Debug$log, 'function', 'init');
	return {
		ctor: '_Tuple2',
		_0: _elm_lang$core$Native_Utils.update(
			_user$project$Reactor$model,
			{
				mdl: A2(_debois$elm_mdl$Material_Layout$setTabsWidth, 1384, _user$project$Reactor$model.mdl)
			}),
		_1: _debois$elm_mdl$Material_Layout$sub0(_user$project$Reactor$Mdl)
	};
}();
var _user$project$Reactor$update = F2(
	function (msg, model) {
		var c = _elm_lang$core$Debug$log('update');
		var b = A2(_elm_lang$core$Debug$log, 'msg', msg);
		var a = A2(_elm_lang$core$Debug$log, 'model', model);
		var _p1 = msg;
		switch (_p1.ctor) {
			case 'Mdl':
				return A3(_debois$elm_mdl$Material$update, _user$project$Reactor$Mdl, _p1._0, model);
			case 'SelectTab':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
...
var _user$project$Reactor$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: A2(_debois$elm_mdl$Material_Layout$subs, _user$project$Reactor$Mdl, model.mdl),
			_1: {ctor: '[]'}
		});
};
var _user$project$Reactor$EmptyTab = function (a) {
	return {ctor: 'EmptyTab', _0: a};
};
var _user$project$Reactor$CustomersTab = function (a) {
	return {ctor: 'CustomersTab', _0: a};
};
var _user$project$Reactor$tabSet = {
	ctor: '::',
	_0: {
		ctor: '_Tuple3',
		_0: 'Customers',
		...
		_2: function (_p2) {
			return A2(
				_elm_lang$html$Html$map,
				_user$project$Reactor$CustomersTab,
				_user$project$Customers$view(
					function (_) {
						return _.customersModel;
					}(_p2)));
		}
	},
	_1: {
		...
		_0: {
			...
			_2: function (_p3) {
				return A2(
					_elm_lang$html$Html$map,
					_user$project$Reactor$EmptyTab,
					_user$project$Empty$view(
						function (_) {
							return _.ordersModel;
						}(_p3)));
			}
		},
		_1: {
...
var _user$project$Reactor$tabViews = _elm_lang$core$Array$fromList(
	A2(
		_elm_lang$core$List$map,
		function (_p5) {
			var _p6 = _p5;
		...
		_user$project$Reactor$tabSet));
var _user$project$Reactor$tabNames = {
	ctor: '_Tuple2',
	_0: A2(
		_elm_lang$core$List$map,
		function (_p7) {
...
var _user$project$Reactor$urlTabs = _elm_lang$core$Dict$fromList(
	A2(
		_elm_lang$core$List$indexedMap,
		F2(
			function (idx, _p9) {
				var _p10 = _p9;
				return {ctor: '_Tuple2', _0: _p10._1, _1: idx};
			}),
		_user$project$Reactor$tabSet));
var _user$project$Reactor$tabUrls = _elm_lang$core$Array$fromList(
	A2(
		_elm_lang$core$List$map,
		function (_p11) {
			var _p12 = _p11;
		...
		_user$project$Reactor$tabSet));
var _user$project$Reactor$urlOf = function (model) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'#',
		A2(
			_elm_lang$core$Maybe$withDefault,
			'',
			A2(_elm_lang$core$Array$get, model.selectedTab, _user$project$Reactor$tabUrls)));
};
var _user$project$Reactor$delta2url = F2(
		...
		return (!_elm_lang$core$Native_Utils.eq(model1.selectedTab, model2.selectedTab)) ? _elm_lang$core$Maybe$Just(
			{
				...
				url: _user$project$Reactor$urlOf(model2)
			}) : _elm_lang$core$Maybe$Nothing;
	});
var _user$project$Reactor$SelectTab = function (a) {
	return {ctor: 'SelectTab', _0: a};
};
var _user$project$Reactor$view = function (model) {
	var stylesheet = _debois$elm_mdl$Material_Options$stylesheet('\n            ');
	var layout = function (main) {
		return A4(
			_debois$elm_mdl$Material_Layout$render,
			_user$project$Reactor$Mdl,
			model.mdl,
			{
				ctor: '::',
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: _debois$elm_mdl$Material_Layout$onSelectTab(_user$project$Reactor$SelectTab),
						_1: {ctor: '[]'}
					}
				}
			},
			{
				...
				drawer: {ctor: '[]'},
				tabs: _user$project$Reactor$tabNames,
				main: {
					ctor: '::',
					_0: stylesheet,
					_1: {
	...
	var currentTab = A2(
		_elm_lang$core$Maybe$withDefault,
		_user$project$Reactor$e404,
		A2(_elm_lang$core$Array$get, model.selectedTab, _user$project$Reactor$tabViews))(model);
	return layout(currentTab);
};
var _user$project$Reactor$location2messages = function (location) {
	return {
		ctor: '::',
		_0: function () {
			var _p13 = A2(_elm_lang$core$String$dropLeft, 1, location.hash);
			if (_p13 === '') {
				return _user$project$Reactor$SelectTab(0);
			} else {
				return _user$project$Reactor$SelectTab(
					A2(
						_elm_lang$core$Maybe$withDefault,
						-1,
						A2(_elm_lang$core$Dict$get, _p13, _user$project$Reactor$urlTabs)));
			}
		}(),
		_1: {ctor: '[]'}
	};
...
var _user$project$Main$main = _rgrempel$elm_route_url$RouteUrl$program(
	{delta2url: _user$project$Reactor$delta2url, location2messages: _user$project$Reactor$location2messages, init: _user$project$Reactor$init, view: _user$project$Reactor$view, update: _user$project$Reactor$update, subscriptions: _user$project$Reactor$subscriptions})();
