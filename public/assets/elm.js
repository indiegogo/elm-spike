...
var _user$project$Data_User$User = F2(
	function (a, b) {
		return {authToken: a, email: b};
	});

var _user$project$Error$PageErrorModel = function (a) {
	return {errorMessage: a};
};
var _user$project$Error$PageError = F2(
	function (a, b) {
		return {ctor: 'PageError', _0: a, _1: b};
	});
var _user$project$Error$Loading = {ctor: 'Loading'};
var _user$project$Error$makeLoadingError = function (eMessage) {
	return A2(
		_user$project$Error$PageError,
		_user$project$Error$Loading,
		{errorMessage: eMessage});
};

var _user$project$Route$BlankRoute = {ctor: 'BlankRoute'};
var _user$project$Route$HomeRoute = {ctor: 'HomeRoute'};
var _user$project$Route$fromLocation = function (location) {
	if (_elm_lang$core$String$isEmpty(location.hash)) {
		return _elm_lang$core$Maybe$Just(_user$project$Route$HomeRoute);
	} else {
		var _p0 = location.hash;
		switch (_p0) {
			case '#blank':
				return _elm_lang$core$Maybe$Just(_user$project$Route$BlankRoute);
			case '#home':
				return _elm_lang$core$Maybe$Just(_user$project$Route$HomeRoute);
			default:
				return _elm_lang$core$Maybe$Nothing;
...
var _user$project$Pages_Home$pageName = 'Welcome Home Page';
var _user$project$Pages_Home$Model = function (a) {
	return {name: a};
};
var _user$project$Pages_Home$init = _user$project$Pages_Home$Model(_user$project$Pages_Home$pageName);
...
var _user$project$Views_Home$margin1 = A2(_debois$elm_mdl$Material_Options$css, 'margin', '0');
var _user$project$Views_Home$white = _debois$elm_mdl$Material_Color$text(_debois$elm_mdl$Material_Color$white);
var _user$project$Views_Home$anMdlCard = A2(
	_debois$elm_mdl$Material_Card$view,
	{
		...
		_1: {
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: _user$project$Views_Home$margin1,
					_1: {ctor: '[]'}
				}
			}
		}
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _user$project$Views_Home$white,
							_1: {
								ctor: '::',
...
var _user$project$Views_Home$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_1: {
				ctor: '::',
				_0: _user$project$Views_Home$anMdlCard,
				_1: {
					ctor: '::',
					_0: _user$project$Views_Home$anMdlCard,
					_1: {
...
var _user$project$Reactor$viewNotFound = A2(
	_elm_lang$html$Html$a,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$href('#aouaoeuaoeuaoeu123'),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
		_0: _elm_lang$html$Html$text('NotFoundError'),
		_1: {ctor: '[]'}
	});
var _user$project$Reactor$viewHome = A2(
	_elm_lang$html$Html$a,
	{
		ctor: '::',
...
var _user$project$Reactor$viewBlank = A2(
	_elm_lang$html$Html$a,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$href('#blank'),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
		_0: _elm_lang$html$Html$text('Mu'),
		_1: {ctor: '[]'}
	});
var _user$project$Reactor$navLinks = {
	ctor: '::',
	_0: A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _user$project$Reactor$viewBlank,
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html$text(' | '),
				_1: {
					ctor: '::',
					_0: _user$project$Reactor$viewHome,
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html$text(' | '),
						_1: {
							ctor: '::',
							_0: _user$project$Reactor$viewNotFound,
							_1: {ctor: '[]'}
						}
					}
				}
...
var _user$project$Reactor$view = function (model) {
	...
	var headerBuilder = function (html) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
			...
			},
			{
				...
				_0: A2(
					...
					A2(
						...
						_user$project$Reactor$navLinks)),
				_1: {ctor: '[]'}
			});
	};
	...
	if (_p0.ctor === 'Loaded') {
		...
		switch (_p1.ctor) {
			case 'HomeApp':
				return layout(
					headerBuilder(
						_user$project$Views_Home$view(_p1._0)));
			case 'BlankApp':
				return headerBuilder(
					_elm_lang$html$Html$text('This is the Page that represents non-thing => mu'));
			default:
				return headerBuilder(
					_elm_lang$html$Html$text('This is the Not Found html page'));
		}
	} else {
		return headerBuilder(
...
var _user$project$Reactor$Model = F2(
	function (a, b) {
		return {pageState: a, mdl: b};
	});
var _user$project$Reactor$HomeApp = function (a) {
	return {ctor: 'HomeApp', _0: a};
};
var _user$project$Reactor$NotFound = {ctor: 'NotFound'};
var _user$project$Reactor$BlankApp = {ctor: 'BlankApp'};
var _user$project$Reactor$LoadingFrom = function (a) {
	return {ctor: 'LoadingFrom', _0: a};
};
var _user$project$Reactor$Loaded = function (a) {
	return {ctor: 'Loaded', _0: a};
};
var _user$project$Reactor$setRoute = F2(
		...
		if (_p2.ctor === 'Nothing') {
			return {
				...
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{
						pageState: _user$project$Reactor$Loaded(_user$project$Reactor$NotFound)
					}),
				_1: _elm_lang$core$Platform_Cmd$none
			};
		} else {
			if (_p2._0.ctor === 'HomeRoute') {
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							pageState: _user$project$Reactor$Loaded(
								_user$project$Reactor$HomeApp(_user$project$Pages_Home$init))
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			} else {
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							pageState: _user$project$Reactor$Loaded(_user$project$Reactor$BlankApp)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			}
...
var _user$project$Reactor$init = function (location) {
	var c = A2(_elm_lang$core$Debug$log, 'function', 'init');
	var b = A2(_elm_lang$core$Debug$log, 'location', location);
	return A2(
		_user$project$Reactor$setRoute,
...
var _user$project$Reactor$update = F2(
	function (msg, model) {
		...
		var _p3 = msg;
		if (_p3.ctor === 'SetRoute') {
			return A2(_user$project$Reactor$setRoute, _p3._0, model);
		} else {
			return A3(_debois$elm_mdl$Material$update, _user$project$Msg$Mdl, _p3._0, model);
		}
	});
...
var _user$project$Main$main = A2(
	...
	{init: _user$project$Reactor$init, view: _user$project$Reactor$view, update: _user$project$Reactor$update, subscriptions: _user$project$Reactor$subscriptions})();
